...
- Remove all default integration kits from PingFederate deployment and upgrade opentoken-adapter to v2.7.2
...
- [X] PDD-5226 Remove all default integration kits from PingFederate deployment and upgrade opentoken-adapter to v2.7.2
